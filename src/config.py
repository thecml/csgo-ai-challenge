...
weapon_list = ['Ak47', 'Aug', 'Awp', 'Bizon', 'Cz75Auto', 'Elite', 'Famas', 'G3sg1', 'GalilAr', 'Glock',
 'M249', 'M4a1S', 'M4a4', 'Mac10', 'Mag7', 'Mp5sd', 'Mp7', 'Mp9', 'Negev', 'Nova', 'P90', 'R8Revolver',
  'Sawedoff', 'Scar20', 'Sg553', 'Ssg08', 'Ump45', 'Xm1014', 'Deagle', 'FiveSeven', 'Glock', 'UspS',
